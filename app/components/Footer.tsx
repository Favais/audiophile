    ...
    return (
        <footer className="bg-brand-dark text-white">
            <div className="max-w-content mx-auto px-6 lg:px-40">
                <div className="h-1 w-[101px] bg-brand-orange mb-12 lg:mb-14" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between gap-8 lg:gap-0 pb-12">
                    ...
                    <nav className="flex flex-col md:flex-row gap-4 md:gap-9 md:items-center lg:ml-auto">
                        <Link
                            href="/"
                            className="text-white text-[13px] font-bold tracking-[2px] uppercase hover:text-brand-orange transition-colors"
                        >
                            Home
                        </Link>
                        <Link
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-12">
                    <div className="md:col-span-1">
                        <p className="text-white/50 text-[15px] font-medium leading-[25px] max-w-[540px]">
                ...
                <div className="pb-12">
                    <p className="text-white/50 text-[15px] font-bold leading-[25px]">
